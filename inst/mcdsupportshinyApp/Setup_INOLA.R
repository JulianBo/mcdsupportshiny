...
configList <- list (
  ...
  Energiewendeziel= list (class="elements",
    description="Mir ist wichtig, wie sehr sich die Region durch regionale erneuerbare Energien mit Energie versorgt.",
    standardweight=45, color="darkred",
    util_func="prop",
    include_parent=TRUE,
    ...
    'Selbstversorgung(Strom)'= list(class="mapping",Attribname=NA,
                                               description="„Es ist mir wichtig, dass sich die Region möglichst zu jedem Zeitpunkt  mit regional produziertem erneuerbarem Strom versorgt“ "),
    'Selbstversorgung(Wärme)'= list(class="mapping",Attribname=NA,
                                   description="Es ist mir wichtig, dass sich die Region möglichst zu jedem Zeitpunkt  mit regional produzierter Wärme bzw. Wärme aus regionalen regenerativen Rohstoffen versorgt.")
  ),
  'Struktur des Energiesystems' = list (class="elements",
    description="Mir ist wichtig, wie das regionale Energiesystem technisch und sozial gestaltet ist.",
    color="orange",
    'Diversität des Energieerzeugungssystems'= list(
      class="elements",
      description="Es ist mir wichtig, dass das regionale Energieerzeugungssystem aus einem breiten Mix unterschiedlicher erneuerbarer Energieerzeugungsanlagen besteht.",
      'Diversität der Stromversorgung'=list(class="mapping",Attribname=NA,
                                            description="Es ist mir wichtig, dass die regionale Stromversorgung aus einem breiten Mix unterschiedlicher erneuerbarer Energieerzeugungsanlagen besteht."),
      'Diversität der Wärmeversorgung'= list(class="mapping",Attribname=NA,
                                      description="Es ist mir wichtig, dass das regionale Wärmesystem aus einem breiten Mix unterschiedlicher erneuerbarer Energieerzeugungsanlagen besteht.")
      ),
    ...
    'Regionale Ausgleichsmechanismen'= list(
      class="elements",
      description="Mir ist wichtig, durch welche Technologien Schwankungen in der regionalen Energieerzeugung ausgeglichen werden.",
      ...
      'Importe/Exporte'=list(class="mapping",Attribname=NA,
                             description="Mir  ist wichtig, dass Schwankungen in der Energieerzeugung durch möglichst wenig Stromimporte und -Exporte ausgeglichen werden."),
      'Abregelung'=list(class="mapping",Attribname=NA,
                        description="Mir ist wichtig, dass Schwankungen in der Energieerzeugung durch möglichst wenig Abregelungen ausgeglichen werden.")
    )
   ),
  ...
  'Umwelteffekte' = list (
    ...
    'Ressourcenbeanspruchung' =list(
      class="mapping",Attribname=NA,
      description="Es ist mir wichtig, dass der Bau/Rückbau von Energieerzeugungsanlagen möglichst weniger Rohstoffe bedarf/möglichst wenig Müll verursacht."
    ),
    'Rückbaumöglichkeit' =list(
      class="mapping",Attribname=NA,
      description="Es ist mir wichtig, dass die gebauten Energieerzeugungsanlagen einfach rückgebaut werden können."
    ),
    'Flächenbeanspruchung' =list(
      class="elements",
      description="Es ist mir wichtig, dass der Bau von Energieerzeugungsanlagen möglichst wenig Fläche beansprucht.",
      'Flächenverbrauch(Abstandsflächen Windkraft)'=list(class="mapping",Attribname=NA,
                                              description="Von den Abstandsflächen für Windkraftanlagen soll wie viel Prozent der Fläche einbezogen werden?"),
      'Flächenverbrauch(Fundamente und Gebäude Windkraft)'=list(class="mapping",Attribname=NA,
                                                        description="Von den Fundamenten und Gebäuden für Windkraftanlagen soll wie viel Prozent der Fläche einbezogen werden?"),
      'Flächenverbrauch(Solardachflächenanlagen)'=list(class="mapping",Attribname=NA,
                                                               description="Von den Solardachflächenanlagen soll wie viel Prozent der Fläche einbezogen werden?"),
      'Flächenverbrauch(Solarfreiflächenanlagen)'=list(class="mapping",Attribname=NA,
                                                       description="Von den Solarfreiflächenanlagen soll wie viel Prozent der Fläche einbezogen werden?"),
      'Flächenverbrauch(tiefe Geothermie)'=list(class="mapping",Attribname=NA,
                                                       description="Von den Geothermieanlagen soll wie viel Prozent der Fläche einbezogen werden?"),
      'Flächenverbrauch(Biomasseanbau)'=list(class="mapping",Attribname=NA,
                                                       description="Vom landwirtschaftlichen Anbau von Biomasse soll wie viel Prozent der Fläche einbezogen werden?")
    ...
    'Anteil Energieproduktion an landwirtschaftlicher Produktion' =list(
      ...
      'Anteil Energieproduktion an Grünschnitt'=list(class="mapping",Attribname=NA,
                                            description="Es ist mir wichtig, dass vom gesamten Grünschnitt nur ein geringer Anteil zur Energieproduktion verwendet wird."),
      'Anteil Energieproduktion an Gülle'=list(class="mapping",Attribname=NA,
                                                     description="Es ist mir wichtig, dass vom gesamten Gülleaufkommen nur ein geringer Anteil zur Energieproduktion verwendet wird."),
  ...
  'Regionale Auswirkungen' = list (
    class="elements",
    description="Mir ist wichtig, welche sonstigen regionalen und lokalen Auswirkungen durch Energieerzeugungsanlagen erzeugt werden (z.B. Verkehrsentwicklung, lokale Emissionsbelastung, Landschaftsbild).",
    color="grey",
    ...
    'Auswirkungen der PV-Freiflächenanlagen' =list(
      class="mapping",Attribname=NA,
      description="Es ist mir wichtig, dass es möglichst geringe regionale Auswirkungen durch Solar-Freiflächenanlagen gibt."
    ),
    'Auswirkungen der PV-Dachflächenanlagen' =list(
      class="mapping",Attribname=NA,
      description="Es ist mir wichtig, dass es möglichst geringe regionale Auswirkungen durch Solar-Dachflächenanlagen gibt."
    ),
    ...
    'Auswirkungen größerer Biomasseanlagen' =list(
      class="mapping",Attribname=NA,
      description="Es ist mir wichtig, dass es möglichst geringe regionale Auswirkungen durch größere Biomasseanlagen gibt."
    ),
    'Auswirkungen der Einzelhausbiomasseanlagen' =list(
      class="mapping",Attribname=NA,
      description="Es ist mir wichtig, dass es möglichst geringe regionale Auswirkungen durch Einzelhausbiomasseanlagen gibt."
    ),
